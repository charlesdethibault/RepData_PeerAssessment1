...
There are `r missing` 2304 items missing in dataset
...
```
With the update, the mean is now `r round(StepsMeanUpdated)` 1.076610^{4} and the median is `r StepsMedianUpdated`1.076618910^{4} 
